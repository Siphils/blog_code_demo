        ...
        if ($this->options->commentsThreaded && $this->is('single')) {
            if ('' != $allows['commentReply']) {
                if (1 == $allows['commentReply']) {
                    $commentScript .= "<script type=\"text/javascript\">
(function () {
...
";
                    ...
                    $commentScript .= '<script src="' . $allows['commentReply'] . '" type="text/javascript"></script>';
                }
            }
        }
        ...
        if (forms.length > 0) {
            ...
            if (null != textarea && 'text' == textarea.name) {
                textarea[event.add](event.focus, function () {
                    ...
                    $commentScript .= '<script src="' . $allows['antiSpam'] . '" type="text/javascript"></script>';
                }
            }
        }
        echo $commentScript;
